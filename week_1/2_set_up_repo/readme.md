...
This section is for Linux users or those who want to challenge themselves.  Later in EDA and in your life as a professional developer, you will use git and access GitHub using the command line (aka "terminal").
